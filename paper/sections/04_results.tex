...
Continued training on RGB images leads to substantial representational reorganization in the Modality Projector and early Propositional Decoder layers (low CKA, high Procrustes disparity). This suggests that ``learning to see red'' requires restructuring the Gain Interface and Plastic Mind, not just adding new features. Interestingly, later LLM layers show higher similarity, indicating that high-level semantic representations remain stable despite low-level restructuring.
