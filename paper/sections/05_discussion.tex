...
\begin{enumerate}
    \item \textbf{Chromatic fine-tuning}: What happens to the ``Wow'' signal as Mary learns to process color? Does it decay as the downstream trainable layers adapt?
