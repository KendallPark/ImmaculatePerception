...
To measure the "subjective shock" of the new format, we employed a \textbf{Paired-Stimulus Design}. We presented the model with identical images in both the Internal (Achromatic) and External (Chromatic) conditions. We hypothesized that the Chromatic condition should trigger a high-energy "surprise" signal, distinct from the low-energy state of recognizing the object in grayscale.
