...
\begin{enumerate}
    ...
    \item \textbf{Modality Projector (Gain Interface):} A trainable multi-modal projector consisting of two Multi-Layer Perceptrons (MLPs) with pixel shuffle downsampling (factor=2). These MLPs map visual embeddings into the semantic space of the language model and represent the tunable interface between sensory data and conceptual knowledge.
