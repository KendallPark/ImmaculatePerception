...
\begin{enumerate}
  ...
  \item \textbf{The Inverted Spectrum}: When we train two identical model architectures with different random seeds, they achieve comparable functional performance (similar accuracy on VQA tasks) but develop structurally different internal representations of color. ``Red'' occupies different geometric positions in their latent spaces---a computational demonstration that functionally equivalent agents can have private, implementation-dependent qualia.
\end{enumerate}
