...
\addbibresource{paper/qualia.bib} %%% Specify the path to a BibLaTeX file
...
\input{paper/sections/02_prior_work}
\input{paper/sections/03_methods}
\input{paper/sections/04_results}
\input{paper/sections/05_discussion}
